...
export const useStyles = makeStyles((theme) => ({
  ...
  eventGradient: {
    ...
    '&:before': {
      ...
      top: 0,
      background:
        'linear-gradient(-90deg, rgb(28 31 35) 20%, rgba(51,51,51,0) 86%)',
    },
  },
  container: {
    padding: '15px 25px',
  ...
  overlay: {
    ...
    '&:before': {
      ...
      pointerEvents: 'none',
      background:
        'linear-gradient(0deg, rgba(34,40,49,1) 0%, rgba(255,255,255,0) 100%)',
    },
  },
  ...
  win: {
    background:
      'linear-gradient(135deg, rgba(100,100,100,0) 40%, rgba(38,170,44,0.2) 100%)',
  },
  lose: {
    background:
      'linear-gradient(135deg, rgba(100,100,100,0) 40%, rgb(205 26 26 / 20%) 100%)',
  },
  removeBtn: {
    position: 'absolute',
    right: '-15px',
