import { Box, Grid, Typography, IconButton } from "../ui";
...
export const TeamItemCard = ({ team, isCoach, index }) => {
    ...
    return (
        <Grid item style={{ width: "fit-content", margin: "10px 20px 30px 20px" }} key={team._id}>
            <Box className={classes.teamCard} onClick={handleClick}>
                ...
                <Box className={classes.front}>
                    <Box className={classes.back}>
                        ...
                        {/* commenting so if we want we can pull it back  */}
                        {/* <button
