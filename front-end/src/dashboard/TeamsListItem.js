...
// CURRENTLY WE ARE NOT USING THIS COMPONENT
export const TeamsListItem = ({ team, onClickDelete, onClickEdit, isCoach }) => {
    ...
    return (
        <Grid item xs={12} sm={6} md={4} lg={3} key={team.id} onClick={handleClick}>
