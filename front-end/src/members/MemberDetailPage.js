...
import { useUser, useCurrentUserInfo, useDiscordUri } from "../users";
...
export const MemberDetailPage = ({ currentUserId }) => {
    ...
    const { discordLinkUrl } = useDiscordUri();
                ...
                <Grid item xs={12}>
                    <Box className={classes.profileDetails}>
                        ...
                        <Box className={classes.detailsContent}>
                            ...
                            <Box display='flex' alignItems='center' justifyContent='center' mb={1}>
                                ...
                                <Box mr={1}>
                                    {user?.discord.linked ? (
                                        ...
                                        <Button
                                            href={`${discordLinkUrl}?dest=profile&email=${user.email}`}
                            ...
                            {!isLoadingOrganizations && Object.keys(organizations).length > 0 && (
                                <Box
                                    style={{
                                        fontSize: "1.2em",
                                        display: "flex",
